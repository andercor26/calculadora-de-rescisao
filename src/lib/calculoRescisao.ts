...
function anosCompletos(admissao: Date, fim: Date): number {
...
function ultimoAniversarioAdmissao(admissao: Date, fim: Date): Date {
...
function primeiroDiaAnoOuAdmissao(admissao: Date, fim: Date): Date {
